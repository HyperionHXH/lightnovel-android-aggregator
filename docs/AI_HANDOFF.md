...
Android 默认版本：`versionName 1.4.2`、`versionCode 9`；桌面和 jpackage 默认版本也是 `1.4.2`。tag Release 工作流会从 tag 注入版本。当前正式 Release 为 `v1.4.2`，含 Android APK、SHA256 和 Windows 压缩包：<https://github.com/HyperionHXH/lightnovel-android-aggregator/releases/tag/v1.4.2>。
