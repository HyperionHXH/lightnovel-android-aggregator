...
Android 默认版本：`versionName 1.10.1`、`versionCode 18`；桌面和 jpackage 默认版本也是 `1.10.1`。tag Release 工作流会从 tag 注入版本。当前正式 Release 为 `v1.10.1`（轻书架 Chapters 接口兼容与非连续 SortNum 导航修复）。
